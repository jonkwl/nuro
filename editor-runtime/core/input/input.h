...
namespace Key {
	...
	static constexpr int BACKSLASH = GLFW_KEY_BACKSLASH;       // Backslash
	static constexpr int RIGHT_BRACKET = GLFW_KEY_RIGHT_BRACKET; // ]
	static constexpr int GRAVE_ACCENT = GLFW_KEY_GRAVE_ACCENT; // `
	static constexpr int WORLD_1 = GLFW_KEY_WORLD_1;           // Non-US #1
	static constexpr int WORLD_2 = GLFW_KEY_WORLD_2;           // Non-US #2
}
...
namespace Key {
	...
	static constexpr int KEY_BACKSLASH = GLFW_KEY_BACKSLASH;       // Backslash
	static constexpr int KEY_RIGHT_BRACKET = GLFW_KEY_RIGHT_BRACKET; // ]
	static constexpr int KEY_GRAVE_ACCENT = GLFW_KEY_GRAVE_ACCENT; // `
	static constexpr int KEY_WORLD_1 = GLFW_KEY_WORLD_1;           // Non-US #1
	static constexpr int KEY_WORLD_2 = GLFW_KEY_WORLD_2;           // Non-US #2
}
*/
