...
void defaultScene() {
	...
	Texture plankAlbedo = Texture::load("./src/example/assets/textures/plank.jpg", TextureType::ALBEDO);
	...
	Model* floorModel = Model::load("./src/example/assets/models/cube.fbx");
	...
	Model* wallModel = Model::load("./src/example/assets/models/cube.fbx");
	...
	Texture smearedWallAlbedo = Texture::load("./src/example/assets/textures/Smeared Wall_BaseColor.jpg", TextureType::ALBEDO);
	Texture smearedWallRoughness = Texture::load("./src/example/assets/textures/Smeared Wall_Roughness.jpg", TextureType::ROUGHNESS);
	Texture smearedWallNormal = Texture::load("./src/example/assets/textures/Smeared Wall_Normal.jpg", TextureType::NORMAL);
	...
	Model* smearedWallModel = Model::load("./src/example/assets/models/cube.fbx");
	...
	Texture mannequinRoughness = Texture::load("./src/example/assets/textures/mannequin_roughness.jpg", TextureType::ROUGHNESS);
	Texture mannequinMetallic = Texture::load("./src/example/assets/textures/mannequin_metallic.jpg", TextureType::METALLIC);
	...
	Model* mannequinModel = Model::load("./src/example/assets/models/mannequin.fbx");
	...
	Model* shadowedSphereModel = Model::load("./src/example/assets/models/sphere.fbx");
	...
	Model* neonModel = Model::load("./src/example/assets/models/pacman_neon_lights.fbx");
	...
	/*Model* dragonModel = Model::load("./src/example/assets/models/dragon.fbx");
	...
	/*Model* audiModel = Model::load("./src/example/assets/models/audi.fbx");
...
void performanceScene() {
	...
	Model* cube = Model::load("./src/example/assets/models/cube.fbx");
