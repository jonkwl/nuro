...
struct HierarchyItem {
	...
	explicit HierarchyItem(EntityContainer entity, std::vector<HierarchyItem> children = {}) : entity(entity), children(children), expanded(false)
	{
	};
...
private:
	...
	// Builds the children of a parent recursively
