	...
	while (!glfwWindowShouldClose(Window::glfw)) {
		...
		if (inspectorMode) {
			if (showEngineUI) {
				...
				InputPair b1 = { "Bloom Intensity", PostProcessing::configuration.bloomIntensity, 0.0f, 2.2f };
				...
				InputPair ld = { "Lens Dirt Intensity", PostProcessing::configuration.lensDirtIntensity, 0.0f, 50.0f };
				...
				EngineDialog::input_dialog("Basic Settings @ Post Processing", { x, a, b, c, b1, b3, b4, b5, d, e, f, g, h, i, j, k, ld });
